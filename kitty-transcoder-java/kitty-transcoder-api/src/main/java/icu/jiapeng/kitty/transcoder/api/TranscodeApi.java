...
public interface TranscodeApi {
    ...
    @GetMapping("/api/transcode/tasks")
    ...
    @Parameter(name = "id", description = "任务ID", required = true, example = "task_123456")
    @GetMapping("/api/transcode/progress/{id}")
    ...
    @Parameter(name = "id", description = "任务ID", required = true, example = "task_123456")
    @GetMapping("/api/transcode/sse/{id}")
    ...
    @GetMapping("/api/transcode/progress/stream")
