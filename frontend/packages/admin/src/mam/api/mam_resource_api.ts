...
export function listResources(params: {
    ...
    return api.get(`/api/material/resource/list`, {params})
}
...
export function pageResources(params: {
    ...
    return api.get(`/api/material/resource/page`, {params})
}
...
export function createFolder(data: {
    ...
    return api.post(`/api/material/resource/folder`, data)
}

export function rebuildPaths(data: { catalogId: string }): Promise<void> {
    return api.post(`/api/material/resource/path/rebuild`, data)
}
...
export function planFolderUpload(data: {
    ...
    return api.post(`/api/material/resource/folder/plan-upload`, data)
}
...
export function saveFingerprint(data: {
    ...
    return api.post(`/api/material/resource/fingerprint`, data)
}
...
export function precheckFingerprint(data: {
    ...
    return api.post(`/api/material/resource/fingerprint/precheck`, data)
}
...
export async function getMetaFile(resourceId: string): Promise<MaterialMetaFileVO | null> {
    const res = await httpClient.get<MaterialMetaFileVO>(`/api/material/resource/meta-file`, {
        params: {resourceId},
        validateStatus: (s) => s >= 200 && s < 300
    })
    if (res.status === 204) return null
    const data = res.data
    if (data == {} as MaterialMetaFileVO || data == null) return null
    return data as MaterialMetaFileVO
}

export function bindMetaFile(data: MaterialMetaFileBindDTO): Promise<MaterialMetaFileVO> {
    return api.post(`/api/material/resource/meta-file/bind`, data)
}

export function getResourceDetail(resourceId: string): Promise<MaterialResourceDetailVO> {
    return api.get(`/api/material/resource/detail`, {params: {resourceId}})
}
