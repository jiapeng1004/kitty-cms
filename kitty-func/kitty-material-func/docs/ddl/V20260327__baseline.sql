...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='栏目表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='存储记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='资源任务表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='栏目权限表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='编目模板表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='编目字段表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='模板字段绑定表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='编目实例表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='审核任务表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='资源物理文件记录';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='资源向量表（多来源）';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='素材转码策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='栏目转码策略绑定';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='分片上传会话';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='分片上传已登记分片';
...
-- 预置栏目：栏目素材库 + 个人栏目（幂等）
INSERT INTO `kt_catalog` (`id`, `parent_id`, `name`, `scope_type`, `tree_code`, `owner_user_id`, `sort_num`, `creator`,
                          `updater`)
SELECT '0',
       '0',
       '栏目素材库',
...
-- 给默认 public 角色预置栏目查看权限（幂等）
INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_cat_material_lib_view_public',
       'public',
       '0',
       ...
       'system',
       'system'
WHERE NOT EXISTS (SELECT 1 FROM `kt_catalog_permission` WHERE `id` = 'perm_cat_material_lib_view_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_pri_view_public',
       'public',
       '-1',
       'material:catalog:tree:view',
       1,
       ...
       'system'
WHERE NOT EXISTS (SELECT 1
                  FROM `kt_catalog_permission`
                  WHERE `id` = 'perm_pri_view_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_cat_material_lib_edit_public',
       'public',
       '0',
       ...
       'system',
       'system'
WHERE NOT EXISTS (SELECT 1 FROM `kt_catalog_permission` WHERE `id` = 'perm_cat_material_lib_edit_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_pri_edit_public',
       'public',
       '-1',
       'material:catalog:update',
       1,
...
WHERE NOT EXISTS (SELECT 1
                  FROM `kt_catalog_permission`
                  WHERE `id` = 'perm_pri_edit_public');


INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_cat_material_lib_add_public',
       'public',
       '0',
       ...
       'system',
       'system'
WHERE NOT EXISTS (SELECT 1 FROM `kt_catalog_permission` WHERE `id` = 'perm_cat_material_lib_add_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_pri_add_public',
       'public',
       '-1',
       'material:catalog:create',
       1,
...
WHERE NOT EXISTS (SELECT 1
                  FROM `kt_catalog_permission`
                  WHERE `id` = 'perm_pri_add_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_cat_material_lib_delete_public',
       'public',
       '0',
       ...
       'system',
       'system'
WHERE NOT EXISTS (SELECT 1 FROM `kt_catalog_permission` WHERE `id` = 'perm_cat_material_lib_delete_public');

INSERT INTO `kt_catalog_permission` (`id`, `role_id`, `catalog_id`, `permission_code`, `allow_flag`, `editable`,
                                     `creator`, `updater`)
SELECT 'perm_pri_delete_public',
       'public',
       '-1',
       'material:catalog:delete',
       1,
       ...
       'system',
       'system'
WHERE NOT EXISTS (SELECT 1 FROM `kt_catalog_permission` WHERE `id` = 'perm_pri_delete_public');
