...
/**
 * 与 {@link icu.jiapeng.kitty.material.resource.controller.MaterialResourceController} 同逻辑；
...
@Validated
public class MaterialResourceApiProvider implements MaterialResourceApi {
