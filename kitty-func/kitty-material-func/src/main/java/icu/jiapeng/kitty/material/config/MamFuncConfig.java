...
import icu.jiapeng.kitty.user.api.db.DefaultTenantDataSource;
import icu.jiapeng.kitty.user.api.db.KtTenSchemaInterceptor;
import icu.jiapeng.kitty.user.api.db.TenantAwareDataSource;
import icu.jiapeng.kitty.user.api.filter.TenFilter;
...
@Import({KittyMetaDataHandler.class,
        ...
        // 缓存配置
        MamCacheConfig.class,
        // 分布式锁配置
        MamDistributedLockOperatorConfig.class
})
@MapperScan(
        value = "icu.jiapeng.kitty.material.**.mapper",
