...
public interface KtOauth2ClientService extends IService<KtOauth2Client> {
    ...
    KtOauth2Client getClientByClientIdWithCache(String clientId);

    PageRespVo<Oauth2ClientVO> query(Oauth2ClientQueryPageDTO query);

    Oauth2ClientVO getDetail(String id);

    Oauth2ClientVO create(Oauth2ClientCreateDTO dto);

    boolean update(String id, Oauth2ClientUpdateDTO dto);
