 ...
 */
package icu.jiapeng.kitty.user.controller.internal.provider;

import cn.dev33.satoken.dao.SaTokenDao;
import cn.dev33.satoken.stp.StpUtil;
import cn.hutool.core.util.StrUtil;
import icu.jiapeng.kitty.user.internal.api.UserInternalAuthApi;
import icu.jiapeng.kitty.user.internal.dto.*;
...
/**
 * 聚合单体等：与 {@link icu.jiapeng.kitty.user.controller.internal.UserInternalAuthController} 同逻辑，
 * 将 {@code @RestController} 换为 {@code @Service} 即可作本地 {@link UserInternalAuthApi} 实现（不注册 MVC 映射）。
 * 与 Controller 通过 profile {@code kitty-user-embedded-api} 互斥。
 */
@Primary
@Service
public class UserInternalAuthApiProvider implements UserInternalAuthApi {
