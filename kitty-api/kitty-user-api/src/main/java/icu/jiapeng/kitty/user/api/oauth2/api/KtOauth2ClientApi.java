...
public interface KtOauth2ClientApi {
    ...
    @GetMapping("/api/user/oauth2-client/query")
    ...
    @GetMapping("/api/user/oauth2-client/{id}")
    ...
    @PostMapping("/api/user/oauth2-client")
    ...
    @PutMapping("/api/user/oauth2-client/{id}")
    ...
    @DeleteMapping("/api/user/oauth2-client/{id}")
