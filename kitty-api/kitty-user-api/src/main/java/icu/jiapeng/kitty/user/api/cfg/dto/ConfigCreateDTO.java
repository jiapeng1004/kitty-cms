 ...
 */
@Data
@Schema(description = "配置项创建参数")
public class ConfigCreateDTO {

    @NotBlank(message = "config.configName.not.blank")
    @Length(max = 64)
    ...
    @NotBlank(message = "config.configWay.not.blank")
    @Schema(description = "配置方式 TEXT|TEXTAREA|RADIO|CHECKBOX")
    private String configWay;

    @NotBlank(message = "{config.classId.not.blank}")
