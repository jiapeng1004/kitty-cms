...
public interface MaterialResourceTaskApi {
    ...
    List<MaterialResourceTaskVO> listByResource(@RequestParam("resourceId") String resourceId);
    ...
    MaterialResourceTaskVO retryTranscode(@RequestParam("taskId") String taskId);
}
